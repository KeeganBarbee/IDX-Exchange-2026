...
print(f"After filtering to Residential, listings have {len(listings_res)} rows") # Counting rows after filtering
# Save to CSV
...
print(f"After filtering to Residential, the sold dataframe {len(sold_res)} rows")
# Save to CSV
